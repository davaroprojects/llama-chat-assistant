...
export function readChromaDbConfig(
    ...
    return {
        ...
        embeddingBatchSize: getConfigValue(config, 'chromaDb.embeddingBatchSize', 'rag.embeddingBatchSize', 32),
        indexWriteBatchSize: getConfigValue(config, 'chromaDb.indexWriteBatchSize', 'rag.indexWriteBatchSize', 64)
    };
}
